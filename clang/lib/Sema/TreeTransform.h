                            ...
                            : Kind == CXXReflectionMetafunctionExpr::MK_DeclOf
                                  ...
                                  : Kind == CXXReflectionMetafunctionExpr::MK_NameOf
                                        ...
                                        : Kind == CXXReflectionMetafunctionExpr::MK_MembersOf
                                              ? tok::kw_members_of
                                              : Kind == CXXReflectionMetafunctionExpr::MK_IsClass
                                                    ? tok::kw_is_class
                                                    : Kind == CXXReflectionMetafunctionExpr::MK_IsFunction
                                                          ? tok::kw_is_function
                                                          : Kind == CXXReflectionMetafunctionExpr::MK_IsNamespace
                                                                ? tok::kw_is_namespace
                                                                : Kind == CXXReflectionMetafunctionExpr::MK_IsEnum
                                                                      ? tok::kw_is_enum
                                                                      : Kind == CXXReflectionMetafunctionExpr::MK_ParentOf
                                                                            ? tok::kw_parent_of
                                                                            : Kind == CXXReflectionMetafunctionExpr::MK_SizeOf
                                                                                  ? tok::kw_size_of
                                                                                  : Kind == CXXReflectionMetafunctionExpr::MK_GetType
                                                                                        ? tok::kw_get_type
                                                                                        : Kind == CXXReflectionMetafunctionExpr::MK_IsPublic
                                                                                              ? tok::kw_is_public
                                                                                              : Kind == CXXReflectionMetafunctionExpr::MK_IsPrivate
                                                                                                    ? tok::kw_is_private
